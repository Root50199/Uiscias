...
Drastically reduces particle count of Blessing of Protection. I may come back to this later to increase the duration of the remaining shell to actually match the buff's duration.
...
Pall of ruination now puts a blue pillar effect and a small nao face on affected enemies for its duration.
Casting Pall places a ring of music notes around the caster to indicate that it is being cast and display its range.
