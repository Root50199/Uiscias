...
[ ] Horse Line
[ ] Astro minigame
[ ] Tail Shadow Mission Map?
[ ] Tara Inside/Outside Shadow Mission Map?
[ ] Corrib Shadow Mission Map?
[ ] Revived Illusion Simplify

## Yes

[ ] Fonts
[ ] Tech Duinn Fog Removal 1/2/3
[ ] Simplfy Pet Animations (e.g. Simplify Crystal Deer [ ] see if we can apply to newer pets)
[ ] Invisible Female Giant Minimization Fix 1/2
[ ] Alternate Success Animation
[ ] Alternate Success Animation File
[ ] Alternate Fail Animation
[ ] Alternate Fail Animation File
[ ] Invisible Male/Female Human Minimization Fix
[ ] Alchemist Shock Removal
[ ] Remove Rain, Sand and Snow 1/2/3 (look at their method)
[ ] Blacksmith Minigame Simplification
[ ] Tailoring Minigame Simplification 1
[ ] Tailoring Minigame Simplification 2
[ ] Screenshot Watermark Removal (test if this even does anything)
[ ] Theater Dungeon Fog Removal (map fog, dungeon fog?)
...
[ ] Cutscene Skips (needs full audit)

## Maybe

[ ] Always Noon Sky
[ ] Vertical Flight Speed
[ ] Simplified Baltane Squire Arena
[ ] Simplified Festia
[ ] Herb Gathering Animation Replacement
[ ] Alchemist FlameBurst Simplify
...
- Remove grim reaper, remove Awakening
